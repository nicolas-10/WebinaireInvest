      ...
      <main className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="text-center max-w-md">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-8 shadow-sm">
            ...
            <p className="text-blue-800 mt-2 font-medium">Revenez bientôt !</p>
          </div>
        </div>
      </main>
    )
    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="max-w-6xl mx-auto px-4 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <span className="inline-block bg-blue-800 text-white text-xs font-bold uppercase tracking-widest px-3 py-1.5 rounded-full mb-6">
              Webinaire PME Canada
            </span>

            <h1 className="text-5xl lg:text-5xl font-extrabold leading-tight mb-6 text-blue-800">
              Trouvez les financements pour faire grandir votre projet.
              
            </h1>

            <p className="text-slate-600 text-lg mb-8 leading-relaxed">
              Découvrez comment obtenir des investissements, structurer 
              votre démarche et être accompagné pour transformer 
              votre idée en véritable opportunité de croissance.
            </p>
            ...
            <ul className="space-y-3">
              {FEATURES.map((item) => (
                <li key={item} className="flex items-center gap-3 text-slate-700">
                  <span className="w-5 h-5 bg-blue-800 rounded-full flex items-center justify-center flex-shrink-0">
